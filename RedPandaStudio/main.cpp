...
int main() {
    ...
    TNode* t2 = rps->createObjectNode(rps->getSceneRoot(), glm::vec3(3,-3,3), "media/cuboprueba.obj");
    ...
    rps::scaleNode(t2, glm::vec3(5,5,5));
    ...
    while( quit ){
        ...
        anim->update(30);
        rps->updateCamera(glm::vec3(20,20,20), glm::vec3(0,0,0));
        rps->updateDevice();
